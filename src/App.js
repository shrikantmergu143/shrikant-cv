                ...
                <div className="row d-flex align-items-center">
                    <div className="col-lg-2">
                        <div className="logo-area">
                            <a href="index-2.html" className="default-logo">
                    ...
                    <div className="col-lg-10 d-flex justify-content-end">
                        <nav id="dropdown" className="template-main-menu">
                            <ul id="onepage_nav">
                                <li className="current"><a href="#wrapper">Home</a></li>
                                <li><a href="#section2">About</a></li>
                                <li><a href="#section3">Skills</a></li>
                                <li><a href="#section4">Experiences</a></li>
                    ...
                    <div className="col-lg-4 col-12 has-animation">
                        <div className="fxt-about-box-layout1">
                            <div className="translate-zoomout-10 opacity-animation transition-50 transition-delay-500">
                                <div className="item-img">
                                    <img data-tilt src="./template/media/about/about1.jpg" alt="About"/>
                                </div>                            
                            </div>
                            <div className="translate-bottom-50 opacity-animation transition-150 transition-delay-1000">
                                <a href="#" className="download-btn btn-fill">DOWNLOAD CV<i className="flaticon-download"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation active-animation">
                        <div className="translate-left-10 opacity-animation transition-200 transition-delay-100">
                            <div className="fxt-service-box-layout1">
                                ...
                                <div className="item-content">
                                    <h3 className="item-title"><a href="#">UI/UX Design</a></h3>
                                    <p>There are many variations passages of Lorem Ipsum available majority have dummy
                                        passage.</p>
                                    <a href="#" className="item-btn">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation active-animation">
                        <div className="translate-left-10 opacity-animation transition-200 transition-delay-700">
                            <div className="fxt-service-box-layout1">
                                ...
                                <div className="item-content">
                                    <h3 className="item-title"><a href="#">Apps Development</a></h3>
                                    <p>There are many variations passages of Lorem Ipsum available majority have dummy
                                        passage.</p>
                                    <a href="#" className="item-btn">Read More</a>
                                </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation active-animation">
                        <div className="translate-left-10 opacity-animation transition-200 transition-delay-100">
                            <div className="fxt-service-box-layout1">
                                ...
                                <div className="item-content">
                                    <h3 className="item-title"><a href="#">Strategy Solutions</a></h3>
                                    <p>There are many variations passages of Lorem Ipsum available majority have dummy
                                        passage.</p>
                                    <a href="#" className="item-btn">Read More</a>
                                </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation active-animation">
                        <div className="translate-left-10 opacity-animation transition-200 transition-delay-300">
                            <div className="fxt-service-box-layout1">
                                ...
                                <div className="item-content">
                                    <h3 className="item-title"><a href="#">Digital Marketing</a></h3>
                                    <p>There are many variations passages of Lorem Ipsum available majority have dummy
                                        passage.</p>
                                    <a href="#" className="item-btn">Read More</a>
                                </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation active-animation">
                        <div className="translate-left-10 opacity-animation transition-200 transition-delay-700">
                            <div className="fxt-service-box-layout1">
                                ...
                                <div className="item-content">
                                    <h3 className="item-title"><a href="#">Social Media</a></h3>
                                    <p>There are many variations passages of Lorem Ipsum available majority have dummy
                                        passage.</p>
                                    <a href="#" className="item-btn">Read More</a>
                                </div>
                ...
                <div className="isotope-wrap">
                    <div className="text-center">
                        <div className="isotope-classes-tab isotop-btn">
                            <a className="current nav-item" data-filter="*">All Categories</a>
                            <a className="nav-item" data-filter=".web">Web Design</a>
                            <a className="nav-item" data-filter=".mockups">Branding Mockups</a>
                            <a className="nav-item" data-filter=".photography">Photography</a>
                        </div>
                    </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-100">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio1.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-400">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio2.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-700">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio3.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-1000">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio4.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-1300">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio5.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-1600">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio6.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-1900">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio7.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-2200">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio8.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                            ...
                            <div className="translate-left-10 opacity-animation transition-200 transition-delay-2500">
                                <div className="fxt-portfolio-box-layout1">
                                    <div className="item-img">
                                        ...
                                        <div className="item-content">
                                            <div className="item-icon"><a href="./template/media/portfolio/portfolio9.jpg" className="popup-zoom"
                                                    data-fancybox-group="gallery"><i className="fas fa-images"></i></a></div>
                                            <h3 className="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div className="item-paragraph">Work description here</div>
                                        </div>
                    ...
                    <div className="col-lg-4 has-animation">
                        <div className="translate-left-10 opacity-animation transition-200 transition-delay-100">
                            <div className="fxt-pricing-box-layout1">
                                ...
                                <a href="#" className="item-btn btn-fill">HIRE ME</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 has-animation">
                                ...
                                <div className="item-content">
                                    <div className="entry-meta">
                                        <ul>
                                            ...
                                            <li><i className="far fa-user"></i><a href="#">Jessica</a></li>
                                        </ul>
                                    </div>
                                    <h3 className="item-title"><a href="single-blog.html">Harbour amid a Slowen
                                            down in singer city.</a></h3>
                                    <p>There are many variations of Lorem is Ipsum is available majority alteration some form
                                        the injected.</p>
                                    <a href="single-blog.html" className="btn-text item-btn">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="fxt-blog-box-layout1">
                                ...
                                <div className="item-content">
                                    <div className="entry-meta">
                                        <ul>
                                            <li><i className="far fa-calendar-alt"></i>14 July, 2017</li>
                                            <li><i className="far fa-user"></i><a href="#">Amac Jajah</a></li>
                                        </ul>
                                    </div>
                                    <h3 className="item-title"><a href="single-blog.html">Trip To Iqaluit In
                            ...
                            <div className="fxt-blog-box-layout1">
                                ...
                                <div className="item-content">
                                    <div className="entry-meta">
                                        <ul>
                                            <li><i className="far fa-calendar-alt"></i>14 July, 2017</li>
                                            <li><i className="far fa-user"></i><a href="#">Sergio Pliego</a></li>
                                        </ul>
                                    </div>
                                    <h3 className="item-title"><a href="single-blog.html">World Travel Holdings
        ...
        <footer className="fxt-footer-section bg-color-2">
            <div className="container">
                <div className="fxt-footer-box-layout1">
                    <div className="copyright-text">©2020 Ree. All Rights Reserved. <a href="#">Terms &amp; Privacy.</a></div>
                </div>
            </div>
        </footer>
    </div>
    <div className="demo_changer">
        ...
        <div className="form_holder">
            ...
            <div className="color-changer">
                <ul>
                    <li>
                        <a href="#" rel="fire-bush" title="fire-bush" className="styleswitch"><img src="switcher/images/icons/fire-bush.jpg" alt="Portfolio"/></a>
                    </li>
                    <li>
                        <a href="#" rel="pastel-green" title="pastel-green" className="styleswitch"><img src="switcher/images/icons/pastel-green.jpg" alt="Portfolio"/></a>
                    </li>
                    <li>
                        <a href="#" rel="electric-violet" title="electric-violet" className="styleswitch"><img src="switcher/images/icons/electric-violet.jpg" alt="Portfolio"/></a>                        
                    </li>
                    <li>
                        <a href="#" rel="blue" title="blue" className="styleswitch"><img src="switcher/images/icons/blue.jpg" alt="Portfolio"/></a> 
                    </li>
                    <li>
                        <a href="#" rel="razzmatazz" title="razzmatazz" className="styleswitch"><img src="switcher/images/icons/razzmatazz.jpg" alt="Portfolio"/></a>                        
                    </li>
                    <li>
                        <a href="#" rel="caribbean-green" title="caribbean-green" className="styleswitch"><img src="switcher/images/icons/caribbean-green.jpg" alt="Portfolio"/></a>                        
                    </li>
                    <li>
                        <a href="#" rel="cornflower-blue" title="cornflower-blue" className="styleswitch"><img src="switcher/images/icons/cornflower-blue.jpg" alt="Portfolio"/></a>                        
                    </li>
                    <li>
                        <a href="#" rel="purple" title="purple" className="styleswitch"><img src="switcher/images/icons/purple.jpg" alt="Portfolio"/></a>                        
                    </li>
                    <li>
                        <a href="#" rel="azure-radiance" title="azure-radiance" className="styleswitch"><img src="switcher/images/icons/azure-radiance.jpg" alt="Portfolio"/></a>                        
                    </li>
                    <li>
                        <a href="#" rel="flush-orange" title="flush-orange" className="styleswitch"><img src="switcher/images/icons/flush-orange.jpg" alt="Portfolio"/></a>
                    </li>
                    <li>
                        <a href="#" rel="apple" title="apple" className="styleswitch"><img src="switcher/images/icons/apple.jpg" alt="Portfolio"/></a>
                    </li>
                    <li>
                        <a href="#" rel="red" title="red" className="styleswitch"><img src="switcher/images/icons/red.jpg" alt="Portfolio"/></a>
                    </li>
                </ul>
            </div>
            ...
            <div className="page-changer">
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="https://affixtheme.com/html/ree/demo/light/index.html"><img src="switcher/images/demo/index.jpg" alt="Portfolio"/></a>
                                <a href="https://affixtheme.com/html/ree/demo/light/index.html">Default Ltr</a>
                            </li>
                            <li>
                                <a href="https://affixtheme.com/html/ree/demo/light/index-rtl.html"><img src="switcher/images/demo/index2.jpg" alt="Portfolio"/></a>
                                <a href="https://affixtheme.com/html/ree/demo/light/index-rtl.html">Default Rtl</a>
                            </li>
                            <li>
                                <a href="https://affixtheme.com/html/ree/demo/light/index2.html"><img src="switcher/images/demo/index3.jpg" alt="Portfolio"/></a>
                                <a href="https://affixtheme.com/html/ree/demo/light/index2.html">Sidebar Ltr</a>
                            </li>
                            <li>
                                <a href="https://affixtheme.com/html/ree/demo/light/index2-rtl.html"><img src="switcher/images/demo/index4.jpg" alt="Portfolio"/></a>
                                <a href="https://affixtheme.com/html/ree/demo/light/index-rtl.html">Sidebar Rtl</a>
                            </li>
                            <li>
                                <a href="https://affixtheme.com/html/ree/demo/light/index3.html"><img src="switcher/images/demo/index5.jpg" alt="Portfolio"/></a>
                                <a href="https://affixtheme.com/html/ree/demo/light/index3.html">Video Ltr</a>
                            </li>
                            <li>
                                <a href="https://affixtheme.com/html/ree/demo/light/index3-rtl.html"><img src="switcher/images/demo/index6.jpg" alt="Portfolio"/></a>
                                <a href="https://affixtheme.com/html/ree/demo/light/index3-rtl.html">Video Rtl</a>
                            </li>
                        </ul>
                    </li>  
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="index-2.html"><img src="switcher/images/demo/index7.jpg" alt="Portfolio"/></a>
                                <a href="index-2.html">Default Ltr</a>
                            </li>
                            <li>
                                <a href="index-rtl.html"><img src="switcher/images/demo/index8.jpg" alt="Portfolio"/></a>
                                <a href="index-rtl.html">Default Rtl</a>
                            </li>
                            <li>
                                <a href="index2.html"><img src="switcher/images/demo/index9.jpg" alt="Portfolio"/></a>
                                <a href="index2.html">Sidebar Ltr</a>
                            </li>
                            <li>
                                <a href="index2-rtl.html"><img src="switcher/images/demo/index10.jpg" alt="Portfolio"/></a>
                                <a href="index-rtl.html">Sidebar Rtl</a>
                            </li>
                            <li>
                                <a href="index3.html"><img src="switcher/images/demo/index11.jpg" alt="Portfolio"/></a>
                                <a href="index3.html">Video Ltr</a>
                            </li>
                            <li>
                                <a href="index3-rtl.html"><img src="switcher/images/demo/index12.jpg" alt="Portfolio"/></a>
                                <a href="index3-rtl.html">Video Rtl</a>
                            </li>
                        </ul>
                    </li>                  
                </ul>
